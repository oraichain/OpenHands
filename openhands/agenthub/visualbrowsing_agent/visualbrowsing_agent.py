...
from typing import Any  # Added missing import for Any type
...
class VisualBrowsingAgent(Agent):
    ...
    def __init__(
        ...
        model_routing_config: Any = None,  # Added to handle this parameter but not use it
        routing_llms: dict[str, LLM] | None = None,  # Added to handle this parameter but not use it
    ) -> None:
        ...
        - mcp_tools (list[dict] | None, optional): MCP tools, not used by this agent. Defaults to None.
        - model_routing_config: Not used by this agent, added for compatibility. 
        - routing_llms: Not used by this agent, added for compatibility.
        """
