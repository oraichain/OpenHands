            ...
            'properties': {
               'is_request_satisfied': {
                ...
                'properties': {
                    ...
                    'answer': {'type': 'boolean', 'description': 'Whether the request is satisfied'}
                }
               },
               'is_in_loop': {
                    'type': 'object',
                ...
                'properties': {
                    'reason': {'type': 'string', 'description': 'The reason for the decision'},
                    'answer': {'type': 'boolean', 'description': 'Whether the request is in a loop'}
                }
               },
               'is_progress_being_made': {
                ...
                'properties': {
                    'reason': {'type': 'string', 'description': 'The reason for the decision'},
                    'answer': {'type': 'boolean', 'description': 'Whether the request is making progress'}
                }
               },
               'next_speaker': {
                'type': 'object',
               ...
               'instruction_or_question': {
                ...
                'properties': {
                    'reason': {'type': 'string', 'description': 'The reason for the decision'},
                    'answer': {'type': 'string', 'description': 'The instruction or question'}
                }
               }
            }
        }
