...
#         print(
#             f"Turn {cache_metadata[i]['turn']}: Cache Read = {cache_metadata[i]['cache_read']}, Cache Write = {cache_metadata[i]['cache_write']}"
#         )
...
#                 print(f'Verification passed for Turn {turn}')
#             else:
#                 print(f'Verification failed for Turn {turn}')
#         else:
#             print(
